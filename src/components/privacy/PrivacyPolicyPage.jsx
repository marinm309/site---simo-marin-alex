        ...
        <div className='privacy-terms-container'>
            ...
            <div>
                ...
                <li>
                    ...
                    <p>We also automatically collect information via the Website through the use of various technologies, including, but not limited to Cookies and Web Beacons (explained below). We may collect your IP address, br/owsing behavior and device IDs. This information is used by us in order to enable us to better understand how our Services are being used by visitors and allows us to administer and customize the Services to improve your overall experience.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ol>
                    <li>
                        <p>When you visit our Services, we may send one or more Cookies – small data files – to your computer to uniquely identify your br/owser and let us help you log in faster and enhance your navigation through the Sites. “Cookies” are text-only pieces of information that a website transfers to an individual’s hard drive or other website br/owsing equipment for record keeping purposes. A Cookie may convey anonymous information about how you br/owse the Services to us so we can provide you with a more personalized experience, but does not collect personal information about you. Cookies allow the Sites to remember important information that will make your use of the site more convenient. A Cookie will typically contain the name of the domain from which the Cookie has come, the “lifetime” of the Cookie, and a randomly generated unique number or other value. Certain Cookies may be used on the Sites regardless of whether you are logged in to your account or not.</p>
                    </li>
                    <li>
                        <p>Session Cookies are temporary Cookies that remain in the Cookie file of your br/owser until you leave the Site.</p>
                    </li>
                    <li>
                        <p>Persistent Cookies remain in the Cookie file of your br/owser for much longer (though how long will depend on the lifetime of the specific Cookie).</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>Third parties with whom we partner to provide certain features on our Site or to display advertising based upon your Web br/owsing activity use Cookies to collect and store information.</p>
                    </li>
                    <li>
                        <p>Our Website may use remarketing services, to serve ads on our behalf across the internet on third party websites to previous visitors to our Sites. It could mean that we advertise to previous visitors who haven’t completed a task on our site. This could be in the form of an advertisement on the Google search results page or a site in the Google Display Network. Third-party vendors, including Google, use Cookies to serve ads based on your past visits to our Website. Any data collected will be used in accordance with our own privacy policy, as well as Google's privacy policies. To learn more, or to opt-out of receiving advertisements tailored to your interests by our third parties, visit the Network Advertising Initiative at <a href="https://www.networkadvertising.org/choices" target="_blank" rel="noreferrer noopener" title="Network Advertising Initiative">www.networkadvertising.org/choices</a>.</p>
                    </li>
                    <li>
                        <p>Lorem Ipsum may use third-party services such as Google Analytics to help understand use of the Services. These services typically collect the information sent by your br/owser as part of a web page request, including Cookies and your IP address. They receive this information and their use of it is governed by their respective privacy policies. You may opt-out of Google Analytics for Display Advertisers including AdWords and opt-out of customized Google Display Network ads by visiting the Google Ads Preferences Manager here <a href="https://adssettings.google.com" target="_blank" rel="noreferrer noopener" title="Google Ads Preferences Manager"></a>. To provide website visitors more choice on how their data is collected by Google Analytics, Google has developed an Opt-out br/owser add-on, which is available by visiting Google Analytics Opt-out br/owser Add-on here <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noreferrer noopener" title="Google Analytics Opt-out br/owser Add-on"></a>.</p>
                    </li>
                    <li>
                        <p>You can control the use of Cookies at the individual br/owser level. Use the options in your web br/owser if you do not wish to receive a Cookie or if you wish to set your br/owser to notify you when you receive a Cookie. You can easily delete and manage any Cookies that have been installed in the Cookie folder of your br/owser by following the instructions provided by your particular br/owser manufacturer. Consult the documentation that your particular br/owser manufacturer provides. You may also consult your mobile device documentation for information on how to disable Cookies on your mobile device. If you reject Cookies, you may still use our Website, but your ability to use some features or areas of our Service may be limited.</p>
                    </li>
                    <li>
                ...
                <li>
                    ...
                    <p>Some web br/owsers may give you the ability to enable a "do not track" feature that sends signals to the websites you visit, indicating that you do not want your online activities tracked. We do not respond to "do not track" signals at this time; if we do so in the future, we will describe how in this Privacy Policy.</p>
                </li>
                <li>
                    <h2>Advertisers</h2>
                    <p>This Site is affiliated with Publisher First, Inc. dba Freestar ("Freestar") for the purposes of placing certain advertising on the Site, and Freestar will collect and use certain data for advertising purposes. To learn more about Freestar’s data usage, click <a target="_blank" rel="noreferrer noopener" href="https://freestar.com/privacy-policy/">here</a>.</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>Contact: Privacy Officer<br/>Email: <a href="mailto:legal@wasai.co">legal@wasai.co</a><br/>Address: 548 Market St, PMB 79780, San Francisco, CA 94104</p>
                </li>
                </ol>
            </div>
            </section>
